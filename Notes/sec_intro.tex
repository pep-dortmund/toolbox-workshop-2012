...
\begin{verbatim}
$ sudo apt-get install python3 python3-numpy python3-scipy ipython3 python3-pyqt4 python3-zmq python3-pygments python3-sip
\end{verbatim}
...
\begin{verbatim}
$ sudo pacman -S git python python-numpy python-scipy ipython pyqt sip python-pygments python-pyzmq
