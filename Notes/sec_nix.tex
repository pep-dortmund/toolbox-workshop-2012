...
\begin{itemize}
  \item Beginning with the Shell: \href{http://youtu.be/Sye3mu-EoTI}{http://youtu.be/Sye3mu-EoTI}
  \item Bash Guide for Beginners: \href{http://tldp.org/LDP/Bash-Beginners-Guide/html/index.html}{http://tldp.org/LDP/Bash-Beginners-Guide/html/index.html}
  \item Advanced Bash-Scripting Guide: \href{http://tldp.org/LDP/abs/html/index.html}{http://tldp.org/LDP/abs/html/index.html}
  \item Zsh Workshop: \href{http://www.acm.uiuc.edu/workshops/zsh/toc.html}{http://www.acm.uiuc.edu/workshops/zsh/toc.html}
  \item Zsh Manual: \href{http://zsh.sourceforge.net/Doc/Release/zsh\_toc.html}{http://zsh.sourceforge.net/Doc/Release/zsh\_toc.html}
\end{itemize}
